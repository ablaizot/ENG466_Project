...
#define MAX_TASKS 1
#define RATE_OF_MOVEMENT 30.0 // how much time required to travel 1 unit of distance (20 seconds per meter travelled)

#define AVG_TASK_PER_SECOND (60.0/(MAX_SIMULATION_TIME*NUM_ROBOTS)*1000)
